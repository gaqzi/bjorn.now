...
Because I got a bit shy from burning tokens Thursday (which turns out to have been [a bug with Anthropic and they reset everyone's quotas](https://x.com/trq212/status/2027232172810416493)) I have been trying to learn more around vibing and I've been using [beads](https://github.com/steveyegge/beads) alone to understand the concepts. And what I'm doing right now is creating the first constraints/invariants, or [principles as Steve called them]({{< relref "crumb/2026-02-26-how-steve-yegge-gets-quality-when-vibing.md" >}}), and will see how the design of the system I want to build turns out when I let it loose tomorrow.
