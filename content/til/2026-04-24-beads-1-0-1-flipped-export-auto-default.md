...
series: []
---
beads 1.0.1 [flipped the `export.auto` default to on](https://github.com/gastownhall/beads/commit/64e504d5#diff-8bba7fff92456c4a9bd807232acd9b5eaf6491c2249600c587d4da4b1ba50492R43), so old projects silently start exporting `issues.jsonl` after upgrade. Run `bd config set export.auto false` to opt back out.
